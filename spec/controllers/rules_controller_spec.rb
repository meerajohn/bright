  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved rule as @rule" do
        ...
        post :create, {:rule => { "category_id" => "invalid value" }}, valid_session
        assigns(:rule).should be_a_new(Rule)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested rule" do
        ...
        Rule.any_instance.should_receive(:update).with({ "category_id" => "1" })
        put :update, {:id => rule.to_param, :rule => { "category_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the rule as @rule" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Rule.any_instance.stub(:save).and_return(false)
        put :update, {:id => rule.to_param, :rule => { "category_id" => "invalid value" }}, valid_session
        assigns(:rule).should eq(rule)
      end
