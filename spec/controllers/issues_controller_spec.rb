  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved issue as @issue" do
        ...
        post :create, {:issue => { "asset_id" => "invalid value" }}, valid_session
        assigns(:issue).should be_a_new(Issue)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested issue" do
        ...
        Issue.any_instance.should_receive(:update).with({ "asset_id" => "1" })
        put :update, {:id => issue.to_param, :issue => { "asset_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the issue as @issue" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Issue.any_instance.stub(:save).and_return(false)
        put :update, {:id => issue.to_param, :issue => { "asset_id" => "invalid value" }}, valid_session
        assigns(:issue).should eq(issue)
      end
